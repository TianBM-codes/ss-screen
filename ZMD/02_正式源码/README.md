...
| [gui.md](gui.md) | [`src/ssscreen/gui/`](../../src/ssscreen/gui/) | 可选 PySide6 桌面工作台、工程树、参数页和 CLI 子进程调用 |
...
4. [cli.md](cli.md)
5. [gui.md](gui.md)
6. [stability.md](stability.md)
7. [测试导航](../03_测试与测试数据/README.md)

## 最近同步

- 2026-09-07：新增可选 `src/ssscreen/gui/` 桌面工作台；`ss-screen-gui` 调用真实 CLI，
  不替代 `ss-screen` 命令行入口。
