...
from aiida_vasp.workchains.v2 import VaspHybridBandUpdater

def get_upd_hse06(node):
    """
    Generate process builder for HSE band structure
    """
...
running = upd.submit()
print(f'Submitted workflow for InSb HSE06 band structure: {running}')